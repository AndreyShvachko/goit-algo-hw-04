...
# Функція реалізації сортування злиттям.
def merge_sort(arr):
    if len(arr) > 1:
        mid = len(arr) // 2
        L = arr[:mid]
...
# Функція реалізації сортування вставками.
...
# Створення функції яка генерує випадковий масив.
def generate_random_array(size):
    return [random.randint(0, 10000) for _ in range(size)]

# Створюємо змінну у якій зберігаємо час виконання алгоритмів.
